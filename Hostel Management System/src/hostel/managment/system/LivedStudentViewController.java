 ...
 * @author Kamrul
 */
public class LivedStudentViewController implements Initializable {

    @FXML
    private TableView<ModelTable> tableLived;
    @FXML
   ...
   ObservableList<ModelTable> Livedlist = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        while(rs.next())
        {
           // model.addRow(new Object[] {rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(1),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9)});
            Livedlist.add(new ModelTable(rs.getString("mobileNo"),rs.getString("name"),rs.getString("father"),rs.getString("mother"),rs.getString("email"),rs.getString("address"),rs.getString("collage"),rs.getString("idNo"),rs.getString("roomNo"),rs.getString("status")));
